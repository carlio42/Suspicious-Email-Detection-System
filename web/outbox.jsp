...
boolean flag=true;
ResultSet rs=statement.executeQuery("select *from inbox where fromuser='"+user+"'");
%>

<%=user.toUpperCase()+" SentMails"%>
<br><br>
  <body>
  <table border=2 style="border-color: rgb(0, 64, 128);">
  <tr>
  <td>
<table cellspacing="20" border=2 bordercolor="rgb(0, 64, 128)">
<tr style="font-weight:bold;background-color:  rgb(0, 64, 128);" >
<td align="center" style="color:white">To</td>
...
flag=false;
 %>
 <tr>
 <td align="center" style="color: "><%=rs.getString(1) %></td>
